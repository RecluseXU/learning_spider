...
def back_projection_demo(sample,target):  # 直方图反向投影
    ...
    cv.imwrite('example/0_Basic_usage_of_the_library/openCV/result/9-3backprojection.png',dst)

src1 = cv.imread('example/0_Basic_usage_of_the_library/openCV/picture/angle_cloths_material.png')
