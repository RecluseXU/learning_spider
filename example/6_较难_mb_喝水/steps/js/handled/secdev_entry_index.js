(function() {
    ...
    var c = n.toLowerCase();
    if (r.indexOf(n) >= 0 || i.host.indexOf(c) >= 0 || top !== self && m.referrer.indexOf(c) >= 0) {
        return
    }
    ...
    if (g) {
        ...
        var w = 0;
        var M = j;
        if (i.host == "sycm.taobao.com" || i.host == "liveplatform.taobao.com") {
            d.nslog = .01;
            w = 1e4
        }
        if ((e() * 1e4 | 0) < w) {
        ...
        var E = l;
        var C = true;
        if (i.hostname.indexOf("buyertrade.taobao.com") > -1 || /refund2\.taobao\.com$|refund2\.tmall\.com$/.test(i.hostname) && i.pathname === "/dispute/apply.htm") {
            if (!C) {
        ...
        var A = r.match(/Edge\/([\d]*)/);
        var D = r.match(/Safari\/([\d]*)/);
        var T = r.match(/Firefox\/([\d]*)/);
        var H = r.match(/MSIE|Trident/);
        if (A) {
            p(O)
        } else if (u) {
            p(O)
            ...
            if (Math.random() < 1e-4) {
                function B(a) {
                    try {
                        if (d.__awsc_et__) {
                            if (Math.random() < 1) {
                                y({}, "https://acjs.aliyun.com/error?v=entry_hk&e=loaded")
                            }
                        } else {
                            var t = +new Date;
                            var r = o(i.href && i.href.split("?")[0] || "url");
                            var n = setInterval(function() {
                                var e = +new Date - t;
                                if (d.__awsc_et__ || e > 2e3) {
                                    y({}, "https://acjs.aliyun.com/error?v=entry_hk&e=wait&tm=" + e + "&u=" + o(a) + "&h=" + r);
                                    clearInterval(n)
                                }
                            }, 50)
                        }
                    } catch (e) {
                        y({}, "https://acjs.aliyun.com/error?v=entry_hk_error&e=" + o(e.message) + "&stack=" + o(e.stack))
                    }
                }
                function W(e, a, t) {
                    switch (t.length) {
                ...
                function X(e, r, n) {
                    return function() {
                        ...
                        return "apply"in e ? e.apply(this, a) : W(this, e, a)
                    }
                }
                function $(e, a, t) {
                    if (!e) {
                ...
                try {
                    var q = "__entry_url";
                    function z(e) {
                        var a = $(e, "open", function(e) {
                            var a = e[1];
                            this[q] = a
                        });
                        var t = $(e, "send", function(e) {
                            var a = this[q];
                            B(a)
                        });
                        return a && t
