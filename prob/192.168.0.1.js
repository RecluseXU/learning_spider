...
(function (n, p) {
    ...
    (function (a, b) {
            ...
            var c = 0,
                ...
                h = function (g, h, k, m, l) {
                    var r, s, p = [],
                        ...
                        M = null != l,
                        w = Ba,
                        t = g || f && v.find.TAG("*", l && h.parentNode || h),
                        ya = U += null == w ? 1 : Math.random() || 0.1;
                    M && (Ba = h !== C && h,
                        Aa = c);
                    for (; null != (l = t[n]); n++) {
                        if (f && l) {
        ...
        function Ib() {}
        var ta, w, Aa, v, Ca, Jb, Ma, Ba, H, ka, C, x, I, D, ma, J, N, F = "sizzle" + -new Date,
            z = a.document,
            U = 0,
            T = 0,
            P = f(),
            ...
            fa = ia.push,
            Y = ia.slice,
            la = ia.indexOf || function (a) {
                for (var b = 0, d = this.length; b < d; b++)
                    if (this[b] === a)
                        return b;
                return -1
            },
            Z = "(?:\\\\.|[\\w-]|[^\\x00-\\xa0])+".replace("w", "w#"),
            aa = "\\[[\\x20\\t\\r\\n\\f]*((?:\\\\.|[\\w-]|[^\\x00-\\xa0])+)[\\x20\\t\\r\\n\\f]*(?:([*^$|!~]?=)[\\x20\\t\\r\\n\\f]*(?:(['\"])((?:\\\\.|[^\\\\])*?)\\3|(" + Z + ")|)|)[\\x20\\t\\r\\n\\f]*\\]",
                        ...
                        function (b, d, k) {
                            ...
                            if (K) {
                                ...
                                if (g && k)
                                    ...
                                    for (;
                                        (l = ++s && l && l[d] || (r = s = 0) || p.pop()) && ((h ? l.nodeName.toLowerCase() !== n : 1 !== l.nodeType) || !++r || (k && ((l[F] || (l[F] = {}))[a] = [U, r]),
                                            l !== b));)
                                ;
                                r -= e;
    ...
    var Z, Kb, Na = /[\t\r\n\f]/g,
        uc = /\r/g,
        vc = /^(?:input|select|textarea|button|object)$/i,
        wc = /^(?:a|area)$/i,
        Oa = /^(?:checked|selected)$/i,
        E = c.support.getSetAttribute,
        ua = c.support.input;
    c.fn.extend({
        attr: function (a, b) {
    ...
    c.event = {
        ...
        trigger: function (a, b, d, e) {
            var f, g, h, k, l, r, s = [d || q],
                m = Y.call(a, "type") ? a.type : a;
    ...
    n.getComputedStyle ? (R = function (a) {
        ...
        A = function (a, b, d) {
            var e, f = (d = d || R(a)) ? d.getPropertyValue(b) || d[b] : p,
                g = a.style;
        ...
        ajax: function (a, b) {
            function d(a, b, d, e) {
                ...
                if (2 !== L) {
                    ...
                    if (d) {
                        s = m;
                        for (var A = t, H, E, C, x, I = s.contents, D = s.dataTypes;
                            "*" === D[0];)
                            D.shift(),
            ...
            "object" === typeof a && (b = a,
                a = p);
            b = b || {};
            var e, f, g, h, k, l, r, n, m = c.ajaxSetup({}, b),
                q = m.context || m,
                M = m.context && (q.nodeType || q.jquery) ? c(q) : c.event,
                y = c.Deferred(),
