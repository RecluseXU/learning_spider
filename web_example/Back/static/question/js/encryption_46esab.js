...
var the_words = $("#the_words"),
    ...
    _ch = function(){
        ...
        // 以下为校验答案代码
        eval(function(p,a,c,k,e,r){e=function(c){return c.toString(a)};if(!''.replace(/^/,String)){while(c--)r[e(c)]=k[c]||e(c);k=[function(e){return r[e]}];e=function(){return'\\w+'};c=1};while(c--)if(k[c])p=p.replace(new RegExp('\\b'+e(c)+'\\b','g'),k[c]);return p}('0.2=\'3+4/\';5(0.6(\'今晚去吃\'+7.1()+\'烤肉吧\')===8.1()){9.1("成功了")}0.2="a+/=";',11,11,'Base64|val|_keyStr|ABCDEFGHIJKL|MNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789|if|encode|the_words|eny_words|disable|ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789'.split('|'),0,{}));
    }
